...
/**
 * <p>Bapiparnr complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="Bapiparnr"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="CountrIso" type="{urn:sap-com:document:sap:rfc:functions}char2"/&gt;
...
public class Bapiparnr {
    ...
    @XmlElement(name = "CountrIso", required = true)
    protected String countrIso;
     ...
     *     
     */
    public void setCountrIso(String value) {
        this.countrIso = value;
    }
