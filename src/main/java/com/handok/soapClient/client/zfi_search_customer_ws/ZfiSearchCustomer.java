 ...
 *       &lt;sequence&gt;
 *         &lt;element name="IGubun" type="{urn:sap-com:document:sap:rfc:functions}char1" minOccurs="0"/&gt;
 *         &lt;element name="IValue" type="{urn:sap-com:document:sap:rfc:functions}char25" minOccurs="0"/&gt;
...
@XmlRootElement(name = "ZfiSearchCustomer")
public class ZfiSearchCustomer {

    @XmlElement(name = "IGubun")
    protected String iGubun;
    @XmlElement(name = "IValue")
     ...
     *     
     */
    public void setIGubun(String value) {
        this.iGubun = value;
    }
