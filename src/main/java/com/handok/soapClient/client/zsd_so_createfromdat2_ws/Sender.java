...
/**
 * <p>Sender complex type에 대한 Java 클래스입니다.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="LogSystem" type="{urn:sap-com:document:sap:rfc:functions}char10"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Sender {
    ...
    @XmlElement(name = "LogSystem", required = true)
    protected String logSystem;

    /**
     * logSystem 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link String }
